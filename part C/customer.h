...
public:
    ...
    {
        if (MenItems.find(ItemIndex).EnoughQuantity(quant))
        {
            addToCart(MenItems.find(ItemIndex), quant);
        }
        else
    ...
    {
        if (WomenItems.find(ItemIndex).EnoughQuantity(quant))
        {
            addToCart(WomenItems.find(ItemIndex), quant);
        }
        else
            cout << " SORRY, WE DO NOT HAVE ENOUGH QUANTITY \n";
    }
    ...
    {
        if (KidsItems.find(ItemIndex).EnoughQuantity(quant))
        {
            addToCart(KidsItems.find(ItemIndex), quant);
        }
        else
            cout << " SORRY, WE DO NOT HAVE ENOUGH QUANTITY \n";
    }
